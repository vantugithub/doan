Contributing to krajee-markdown-editor
======================================
Looking to contribute something to krajee-markdown-editor? **Here's how you can help.**
...
[plugin documentation](http://plugins.krajee.com/markdown-editor), 
[plugin demos](http://plugins.krajee.com/markdown-editor/demo), and / or refer to the
[webtips Q & A forum](http://webtips.krajee.com/questions) which are the better places to get help.

Reporting bugs with krajee-markdown-editor
---------------------------------------
We really appreciate clear bug reports that _consistently_ show an issue
_within krajee-markdown-editor_.
...
- What version of jQuery are you using? And what version of krajee-markdown-editor?
- Are you using krajee-markdown-editor with other plugins?

All of these questions will help others fix and identify any potential bugs.

Requesting features in krajee-markdown-editor
------------------------------------------
Before starting work on a major feature for krajee-markdown-editor, **read the
[documentation](http://plugins.krajee.com/markdown-editor)  first** or you may risk spending a considerable amount of
...
krajee-markdown-editor regularly receives new issues which need to be tested and organized.
...
If you can test issues that are reported to krajee-markdown-editor that contain test cases and
...
It should also be made clear that **all code contributed to krajee-markdown-editor** must be
licensable under the [BSD-3 license][licensing].  Code that cannot be released
under this license **cannot be accepted** into the project.

[isolated-case]: https://jsfiddle.net/
[issue-search]: https://github.com/kartik-v/krajee-markdown-editor/search?q=&type=Issues
[issue-tracker]: https://github.com/kartik-v/krajee-markdown-editor/issues
[licensing]: https://github.com/kartik-v/krajee-markdown-editor/blob/master/LICENSE.md
[reporting-bugs]: #reporting-bugs-with-krajee-markdown-editor
[requesting-features]: #requesting-features-in-krajee-markdown-editor