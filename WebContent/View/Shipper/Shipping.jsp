											...
											<tbody>
												...
												<c:forEach items="${list}" var="lis">
													<tr>
														...
														<td>${lis.total}</td>
														<td><a
															href="/Laptop/shipper/shippingDetail?id=${lis.id}&change=1"><i
								...
								<ul class="pagination">
									<c:if test="${numberPage == 1}">
										...
										<li class="page-item"><a class="page-link"
											href="<%=request.getContextPath()%>/shipper/shipping?page=1">1</a></li>
										<li class="page-item"><a class="page-link"
											href="<%=request.getContextPath()%>/shipper/shipping?page=2">2</a></li>
										<li class="page-item"><a class="page-link"
											href="<%=request.getContextPath()%>/shipper/shipping?page=${numberPage+1}">Next</a></li>
									</c:if>

									<c:if test="${numberPage == maxPageId}">
										<li class="page-item"><a class="page-link"
											href="<%=request.getContextPath()%>/shipper/shipping?page=${numberPage-1}">Prev</a></li>
										<li class="page-item"><a class="page-link"
											href="<%=request.getContextPath()%>/shipper/shipping?page=1">1</a></li>
										<li class="page-item"><a class="page-link"
											href="<%=request.getContextPath()%>/shipper/shipping?page=2">2</a></li>
