							...
							<c:forEach items="${list2}" var="lis2">
								<div class="card-body">
									<div style="margin: auto">
										<table
											style="margin-left: 150px; color: rgba(255, 255, 255, 0.7)">
											<tr>
								...
								<div class="">
									...
									<div style="text-align: center">
										<button class="btn btn-success" data-toggle="modal"
											...
											<a
												href="/Laptop/shipper/successOrder?orderId=<%=request.getParameter("id")%>"
												style="color: white">Success</a>
										</button>
										<button class="btn btn-primary" data-toggle="modal"
											data-target="#exampleModal">
											<a
												href="/Laptop/shipper/cancelOrder?orderId=<%=request.getParameter("id")%>"
												style="color: white">Failed</a>
										</button>
									</div>
									<%
									}
