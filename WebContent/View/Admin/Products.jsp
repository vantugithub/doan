			...
			<div class="content">
				...
				<ul class="pagination">
					<c:if test="${numberPage == 1}">
						...
						<li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/admin/products?page=1">1</a></li>
						<li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/admin/products?page=2">2</a></li>
					...
					<c:if test="${numberPage == maxPageId}">
						<li class="page-item"><a class="page-link"
							href="<%=request.getContextPath()%>/admin/products?page=${numberPage-1}">Prev</a></li>
						<li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/admin/products?page=1">1</a></li>
						<li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/admin/products?page=2">2</a></li>
					</c:if>
