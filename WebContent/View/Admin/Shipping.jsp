											...
											<tbody>
												...
												<c:forEach items="${list}" var="lis" varStatus="status">
													<tr>
														...
														<td>${lis.total}</td>
														<td><a
															href="/Laptop/admin/detailorder?id=${lis.id}"><i
								...
								<ul class="pagination">
									<c:if test="${numberPage == 1}">
										...
										<li class="page-item"><a class="page-link"
											href="<%=request.getContextPath()%>/admin/shipping?page=1">1</a></li>
										<li class="page-item"><a class="page-link"
											href="<%=request.getContextPath()%>/admin/shipping?page=2">2</a></li>
										<li class="page-item"><a class="page-link"
											href="<%=request.getContextPath()%>/admin/shipping?page=${numberPage+1}">Next</a></li>
									</c:if>

									<c:if test="${numberPage == maxPageId}">
										<li class="page-item"><a class="page-link"
											href="<%=request.getContextPath()%>/admin/shipping?page=${numberPage-1}">Prev</a></li>
										<li class="page-item"><a class="page-link"
											href="<%=request.getContextPath()%>/admin/shipping?page=1">1</a></li>
										<li class="page-item"><a class="page-link"
											href="<%=request.getContextPath()%>/admin/shipping?page=2">2</a></li>
